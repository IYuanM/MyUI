...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] descs = new String[]{"可爱的小孩", "一个擅长音乐的女孩",
            "一个擅长文学的女性", "浪漫主义诗人"};
    private int[] imageIds = new int[]{R.drawable.tiger1,
            R.drawable.nongyu, R.drawable.qingzhao, R.drawable.libai};
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.linear_my);
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, listItems,
                ...
                new int[]{R.id.name, R.id.header, R.id.desc});   //就是利用id进行双方之间的交互。
        ListView list = findViewById(R.id.mylist);    //调用linear_my.xml中的mylist,里面是不是创建了！
        // 为ListView设置Adapter
